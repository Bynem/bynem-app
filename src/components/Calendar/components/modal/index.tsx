...
export default function ModalContent({ open, day, setOpenModal, freeHours, registering, uuid, serviceId, provider, selectedTimesDay }: Input) {
      ...
      >
        <Fade in={open}>
          <Box style={{
            ...
            {registering ?
              (
                <SaveHoursService day={day} selectedTimesDay={selectedTimesDay} setOpenModal={setOpenModal} serviceId={serviceId} provider={provider} />
              ) :
              (
