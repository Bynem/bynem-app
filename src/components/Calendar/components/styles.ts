...
function daysAvailable(day: moment.Moment, freeHours: FreeHours[]): any {
...
export default function dayStyles(day: moment.Moment, value: moment.Moment, freeHours: FreeHours[]) {
  if (daysAvailable(day, freeHours)) return "daysAvailable"
